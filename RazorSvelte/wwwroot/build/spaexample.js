var spaexample = (function () {
    ...
    */
    ...
    const file$7 = "App\\lib\\offcanvas.svelte";
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h5, file$7, 139, 12, 4234);
    			attr_dev(div, "class", "offcanvas-header");
    			add_location(div, file$7, 138, 8, 4190);
    		},
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$7, 146, 12, 4462);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_pending_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file$7, 155, 24, 4781);
    			attr_dev(div, "class", "text-center");
    			add_location(div, file$7, 154, 20, 4730);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, i);
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$7, 150, 4, 4591);
    			...
    			add_location(div1, file$7, 136, 0, 3958);
    		},
    ...
    const file$6 = "App\\shared\\layout\\link-list-items.svelte";
    ...
    const file$5 = "App\\shared\\layout\\offcanvas-layout.svelte";
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$5, 86, 25, 2454);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$5, 88, 8, 2705);
    			attr_dev(ul, "class", "navbar-nav navbar-dark flex-column mt-4");
    			add_location(ul, file$5, 89, 8, 2846);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			insert_dev(target, t, anchor);
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i0, file$5, 101, 20, 3256);
    			attr_dev(span, "class", "font-monospace");
    			add_location(span, file$5, 102, 20, 3342);
    			attr_dev(button0, "class", "btn btn-primary");
    			add_location(button0, file$5, 100, 16, 3167);
    			attr_dev(div0, "class", "d-flex float-start");
    			add_location(div0, file$5, 99, 12, 3117);

    			attr_dev(i1, "class", i1_class_value = /*$isDarkTheme*/ ctx[3]
    			? "bi-lightbulb"
    			: "bi-lightbulb-off");

    			add_location(i1, file$5, 121, 20, 4335);
    ...
    /* App\spa-views\home.svelte generated by Svelte v3.55.1 */

    const file$4 = "App\\spa-views\\home.svelte";
    ...
    /* App\spa-views\about.svelte generated by Svelte v3.55.1 */

    const file$3 = "App\\spa-views\\about.svelte";
    ...
    /* App\spa-views\parametrized.svelte generated by Svelte v3.55.1 */

    const file$2 = "App\\spa-views\\parametrized.svelte";
    ...
    /* App\spa-views\unknown.svelte generated by Svelte v3.55.1 */

    const file$1 = "App\\spa-views\\unknown.svelte";
    ...
    /* App\spa-example.svelte generated by Svelte v3.55.1 */
    const file = "App\\spa-example.svelte";
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div1 = element("div");
    			h3 = element("h3");
    			h3.textContent = "Spa Example";
    			t1 = space();
    			p0 = element("p");
    			t2 = text("This is an example of the Single-Page App (SPA) by using \r\n            ");
    			a0 = element("a");
    			a0.textContent = "svelte-spa-router";
    			t4 = text(" component.");
    			t5 = space();
    			p1 = element("p");
    			t6 = text("See ");
    			...
    			li2 = element("li");
    			a5 = element("a");
    			a5.textContent = "Parametrized with \"AAA\"";
    			t17 = space();
    			li3 = element("li");
    			a6 = element("a");
    			a6.textContent = "Parametrized with \"BBB\"";
    			t19 = space();
    			li4 = element("li");
    			a7 = element("a");
    			a7.textContent = "Unknown route";
    			t21 = space();
    			div0 = element("div");
    			create_component(router.$$.fragment);
    			add_location(h3, file, 13, 8, 473);
    			attr_dev(a0, "class", "btn-link");
    			attr_dev(a0, "href", "https://www.npmjs.com/package/svelte-spa-router");
    			add_location(a0, file, 16, 12, 591);
    			add_location(p0, file, 14, 8, 503);
    			attr_dev(a1, "class", "btn-link");
    			attr_dev(a1, "href", "https://svelte.dev/repl/6e7546119cff41fabe35df3ef999ff7e?version=3.29.4");
    			add_location(a1, file, 19, 16, 743);
    			attr_dev(a2, "class", "btn-link");
    			attr_dev(a2, "href", "https://github.com/ItalyPaleAle/svelte-spa-router");
    			add_location(a2, file, 20, 12, 872);
    			add_location(p1, file, 18, 8, 722);
    			attr_dev(a3, "class", "nav-link");
    			attr_dev(a3, "href", "#");
    			toggle_class(a3, "active", /*hash*/ ctx[0] == "");
    			add_location(a3, file, 26, 16, 1146);
    			attr_dev(li0, "class", "nav-item");
    			add_location(li0, file, 24, 12, 1044);
    			attr_dev(a4, "class", "nav-link");
    			attr_dev(a4, "href", "#/about");
    			toggle_class(a4, "active", /*hash*/ ctx[0] == "#/about");
    			add_location(a4, file, 29, 16, 1281);
    			attr_dev(li1, "class", "nav-item");
    			add_location(li1, file, 28, 12, 1242);
    			attr_dev(a5, "class", "nav-link");
    			attr_dev(a5, "href", "#/parametrized/AAA");
    			toggle_class(a5, "active", /*hash*/ ctx[0] == "#/parametrized/AAA");
    			add_location(a5, file, 32, 16, 1430);
    			attr_dev(li2, "class", "nav-item");
    			add_location(li2, file, 31, 12, 1391);
    			attr_dev(a6, "class", "nav-link");
    			attr_dev(a6, "href", "#/parametrized/BBB");
    			toggle_class(a6, "active", /*hash*/ ctx[0] == "#/parametrized/BBB");
    			add_location(a6, file, 35, 16, 1619);
    			attr_dev(li3, "class", "nav-item");
    			add_location(li3, file, 34, 12, 1580);
    			attr_dev(a7, "class", "nav-link");
    			attr_dev(a7, "href", "#/test");
    			add_location(a7, file, 38, 16, 1808);
    			attr_dev(li4, "class", "nav-item");
    			add_location(li4, file, 37, 12, 1769);
    			attr_dev(ul, "class", "nav nav-tabs");
    			add_location(ul, file, 23, 8, 1005);
    			attr_dev(div0, "class", "p-0 mt-3");
    			add_location(div0, file, 42, 8, 1905);
    			attr_dev(div1, "class", "container mt-3");
    			add_location(div1, file, 11, 4, 433);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, h3);
    ...
    function instance($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('Spa_example', slots, []);
    	let hash = document.location.hash;
    	window.onhashchange = () => $$invalidate(0, hash = document.location.hash);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Spa_example> was created with unknown prop '${key}'`);
    	});
    ...
    class Spa_example extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    var SpaExample_entry = new Spa_example({ target: document.body });
